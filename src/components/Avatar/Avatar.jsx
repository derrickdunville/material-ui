    ...
    return (
      <div className={classes.logoImage} style={{color: "#FFFFFF", display: 'flex', alignItems: "center", padding:"10px", height: "56px" }}>
        {this.props.avatar != null ? (
          <img src={`https://s3.amazonaws.com/${this.props.avatar.bucket}/${this.props.avatar.key}`} className={classes.img} style={{width: "50px", height: "50px", borderRadius: "4px"}}/>
        ):(
          <img src={logo} className={classes.img} style={{width: "50px", height: "50px", borderRadius: "4px"}}/>
        )}
        <div style={{marginLeft: "10px", paddingRight: "10px", flex: '1'}}>{this.props.username}</div>
      </div>
    )
  }
}
